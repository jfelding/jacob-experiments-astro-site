...
export const SITE_URL = "https://jacob-experiments.com";
...
export const IDEAS: Metadata = {
  TITLE: "Project Ideas and thoughts",
  DESCRIPTION: "Loose thoughts and things I would like to explore.",
};
